...
export function HeroSection() {
  return (
    <section className="border-b">
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-2 lg:grid-cols-2 lg:items-center">
          <div className='flex flex-col justify-center container  items-center md:items-start md:text-start'>
            <div className='flex-1 flex flex-col justify-center'>
              <p className="text-sm font-medium italic tracking-widest text-primary">
                University research platform
              </p>
              <h1 className='md:text-4xl sm:max-w-2xl sm:text-3xl lg:text-5xl text-2xl font-extrabold tracking-tight text-balance relative z-10 bg-clip-text text-transparent bg-linear-to-b from-foreground to-muted-foreground '>
                Empower Your{' '}
              ...
              <p className='mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base md:border-l-2 pl-2 md:border-primary sm:mt-6 sm:max-w-2xl sm:mx-auto md:mt-8 md:text-lg lg:mx-0'>
                Researcher connects students, supervisors, and administrators with
                AI-powered tools for collaboration, structured evaluation, and
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                <Button asChild variant="outline" size="lg">
                  <Link href="#features">Explore Past Projects </Link>
                </Button>
              </div>
            </div> 
          </div>

          <div className='hidden z-30 flex-1 lg:flex justify-center items-end  min-h-128 max-w-3xl content-end bg-slate-400 rounded-bl-[12rem]'>
            <div className='relative h-full w-full rounded-bl-[12rem] min-h-128'> 
              <Image
                src={'/images/wow.avif'} 
                alt="Research project dashboard preview"  
                fill 
                priority
                sizes="(max-width: 1024px) 100vw, 50vw"
                className='clip-polyi object-cover h-full w-full rounded-bl-[12rem]'
              /> 
              <div className='absolute top-8 flex gap-2 rounded px-4 py-2 justify-center items-center -left-24 bg-primary/45 shadow-sm backdrop-blur supports-backdrop-filter:bg-primary/45 transition-transform -rotate-4'>
                <svg
              ...
              <div className='absolute bottom-24 flex gap-2 rounded px-4 py-2 justify-center items-center -left-32 bg-primary/45 shadow-sm backdrop-blur supports-backdrop-filter:bg-primary/45 transition-transform rotate-2'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
                  viewBox='0 0 512 512'
